...
% imaging scenarios (called A and B), computing a one-sided confidence
...
% one-sided intervals
alpha1=alpha;  % lower significance level
alpha2=0;  % upper significance level 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp(' ')
disp(['Displaying one-sided ',num2str((1-alpha)*100,2),'% confidence intervals for AUC difference:'])
disp(' ')
