% demo1b.m
% Demonstrate AUC point estimators and one-sided confidence intervals for a 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp(' ')
disp(['Displaying oned-sided ',num2str((1-alpha)*100,2),'% confidence intervals for AUC:'])
disp(' ')
